//
//  CalculatorFood3ViewController.swift
//  WhatTheImpact
//
...
class CalculatorFood3ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @IBAction func foodButton1(_ sender: Any) {
        ...
        case "Maize (Meal)": foodItemRecommendCO2 = 2
        case "Oatmeal": foodItemRecommendCO2 = 2
        case "Pasta": foodItemRecommendCO2 = 5
        case "Potatoes": foodItemRecommendCO2 = 3
        case "Rice": foodItemRecommendCO2 = 3
        case "Bread": foodItemRecommendCO2 = 2
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Maize (Meal)": foodItemRecommendWater = 1
        case "Oatmeal": foodItemRecommendWater = 1
        case "Pasta": foodItemRecommendWater = 4
        case "Potatoes": foodItemRecommendWater = 2
        case "Rice": foodItemRecommendWater = 3
        case "Bread": foodItemRecommendWater = 2
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Maize (Meal)": foodItemRecommendSO2 = 2
        case "Oatmeal": foodItemRecommendSO2 = 2
        case "Pasta": foodItemRecommendSO2 = 5
        case "Potatoes": foodItemRecommendSO2 = 3
        case "Rice": foodItemRecommendSO2 = 2
        case "Bread": foodItemRecommendSO2 = 1
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Maize (Meal)": foodItemRecommendLand = 5
        case "Oatmeal": foodItemRecommendLand = 1
        case "Pasta": foodItemRecommendLand = 5
        case "Potatoes": foodItemRecommendLand = 3
        case "Rice": foodItemRecommendLand = 5
        case "Bread": foodItemRecommendLand = 1
