//
//  CalculatorFood5ViewController.swift
//  WhatTheImpact
//
...
class CalculatorFood5ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @IBAction func foodButton1(_ sender: Any) {
        ...
        case "Chocolate": foodItemRecommendCO2 = 3
        case "Lentils": foodItemRecommendCO2 = 3
        case "Nuts": foodItemRecommendCO2 = 3
        case "Olive Oil": foodItemRecommendCO2 = 9
        case "Palm Oil": foodItemRecommendCO2 = 9
        case "Rapeseed Oil": foodItemRecommendCO2 = 9
        case "Soybean Oil": foodItemRecommendCO2 = 9
        case "Soymilk": foodItemRecommendCO2 = 8
        case "Sunflower Oil": foodItemRecommendCO2 = 9
        case "Tofu": foodItemRecommendCO2 = 2
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Chocolate": foodItemRecommendWater = 1
        case "Lentils": foodItemRecommendWater = 10
        case "Nuts": foodItemRecommendWater = 10
        case "Olive Oil": foodItemRecommendWater = 5
        case "Palm Oil": foodItemRecommendWater = 5
        case "Rapeseed Oil": foodItemRecommendWater = 5
        case "Soybean Oil": foodItemRecommendWater = 5
        case "Soymilk": foodItemRecommendWater = 8
        case "Sunflower Oil": foodItemRecommendWater = 5
        case "Tofu": foodItemRecommendWater = 10
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Chocolate": foodItemRecommendSO2 = 3
        case "Lentils": foodItemRecommendSO2 = 10
        case "Nuts": foodItemRecommendSO2 = 10
        case "Olive Oil": foodItemRecommendSO2 = 7
        case "Palm Oil": foodItemRecommendSO2 = 7
        case "Rapeseed Oil": foodItemRecommendSO2 = 7
        case "Soybean Oil": foodItemRecommendSO2 = 7
        case "Soymilk": foodItemRecommendSO2 = 8
        case "Sunflower Oil": foodItemRecommendSO2 = 7
        case "Tofu": foodItemRecommendSO2 = 10
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Chocolate": foodItemRecommendLand = 3
        case "Lentils": foodItemRecommendLand = 10
        case "Nuts": foodItemRecommendLand = 10
        case "Olive Oil": foodItemRecommendLand = 5
        case "Palm Oil": foodItemRecommendLand = 5
        case "Rapeseed Oil": foodItemRecommendLand = 5
        case "Soybean Oil": foodItemRecommendLand = 5
        case "Soymilk": foodItemRecommendLand = 8
        case "Sunflower Oil": foodItemRecommendLand = 5
        case "Tofu": foodItemRecommendLand = 10
