//
//  CalculatorFood2ViewController.swift
//  WhatTheImpact
//
...
class CalculatorFood2ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        foodPickerOneData = ["Beef", "Shrimp (farmed)", "Fish (farmed)", "Lamb", "Pork", "Chicken & Turkey"]
        ...
        portionData = ["75g", "5 large prawns (40g)", "140g", "75g", "75g", "75g"]
    ...
    @IBAction func foodButton1(_ sender: Any) {
        ...
        foodCarbonValues = [
            ["Product", "CO2 Emissions", "Freshwater Withdrawals", "Acidifying Emissions", "Land Use"],     ["Beef", "387.972", "5659.68", "1243.437", "1272.219"],     ["Shrimp (farmed)", "52.3965", "6855.03", "259.4865", "5.7915"],     ["Fish (farmed)", "99.2264", "26872.664", "479.8248", "61.2248"],     ["Lamb", "154.908", "7030.92", "541.983", "1442.259"],     ["Pork", "48.009", "7003.62", "556.374", "67.704"],     ["Chicken & Turkey", "38.493", "2574", "399.438", "47.658"]]
        ...
        case "Beef": foodItemRecommendCO2 = 6
        case "Shrimp (farmed)": foodItemRecommendCO2 = 6
        case "Fish (farmed)": foodItemRecommendCO2 = 2
        case "Lamb": foodItemRecommendCO2 = 6
        case "Pork": foodItemRecommendCO2 = 6
        case "Chicken & Turkey": foodItemRecommendCO2 = 6
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Beef": foodItemRecommendWater = 6
        case "Shrimp (farmed)": foodItemRecommendWater = 6
        case "Fish (farmed)": foodItemRecommendWater = 2
        case "Lamb": foodItemRecommendWater = 6
        case "Pork": foodItemRecommendWater = 6
        case "Chicken & Turkey": foodItemRecommendWater = 6
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Beef": foodItemRecommendSO2 = 6
        case "Shrimp (farmed)": foodItemRecommendSO2 = 2
        case "Fish (farmed)": foodItemRecommendSO2 = 2
        case "Lamb": foodItemRecommendSO2 = 6
        case "Pork": foodItemRecommendSO2 = 6
        case "Chicken & Turkey": foodItemRecommendSO2 = 2
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Beef": foodItemRecommendLand = 6
        case "Shrimp (farmed)": foodItemRecommendLand = 2
        case "Fish (farmed)": foodItemRecommendLand = 2
        case "Lamb": foodItemRecommendLand = 6
        case "Pork": foodItemRecommendLand = 6
        case "Chicken & Turkey": foodItemRecommendLand = 2
    ...
    @IBAction func saveToDashboardButton(_ sender: Any) {
        ...
        print("EEEEE")
        print(yourImpactOutputFive)
        print("EEEEE")
        yourImpactItem.setValue(yourImpactOutputFive, forKey: "detail")

        print("EEEEE")
        print(yourImpactOutputSix)
        print("EEEEE")
        yourImpactItem.setValue(yourImpactOutputSix, forKey: "so2")

        print("EEEEE")
        print(yourImpactOutputSeven)
        print("EEEEE")
        yourImpactItem.setValue(yourImpactOutputSeven, forKey: "land")
