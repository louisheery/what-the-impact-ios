//
//  CalculatorFood6ViewController.swift
//  WhatTheImpact
//
...
class CalculatorFood6ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        foodPickerOneData = ["Beer", "Coffee", "Wine"]

        foodPickerTwoData = ["1", "2", "3", "4", "5", "6", "7"]

        portionText = "1 pint (0.568ml)"
        foodPortionLabelA.text = "1 Portion\nNote: Each Portion = " + String(portionText)

        portionData = ["1 pint (0.568ml)", "1 cup (8g of beans)", "1 medium glass (175ml)"]
    ...
    @IBAction func foodButton1(_ sender: Any) {
        ...
        foodCarbonValues = [
            ["Product", "CO2 Emissions", "Freshwater Withdrawals", "Acidifying Emissions", "Land Use"],     ["Beer", "34.85248", "505.0656", "194.64224", "32.78496"],     ["Coffee", "11.86848", "10.7744", "34.58624", "8.99392"],     ["Wine", "16.289", "717.99", "116.116", "16.198"]]
        ...
        case "Beer": foodItemRecommendCO2 = 3
        case "Coffee": foodItemRecommendCO2 = 2
        case "Wine": foodItemRecommendCO2 = 2
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Beer": foodItemRecommendWater = 2
        case "Coffee": foodItemRecommendWater = 2
        case "Wine": foodItemRecommendWater = 1
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Beer": foodItemRecommendSO2 = 3
        case "Coffee": foodItemRecommendSO2 = 2
        case "Wine": foodItemRecommendSO2 = 3
        ...
        switch foodCarbonValues[foodItemSelected + 1][0] {
        case "Beer": foodItemRecommendLand = 3
        case "Coffee": foodItemRecommendLand = 2
        case "Wine": foodItemRecommendLand = 2
